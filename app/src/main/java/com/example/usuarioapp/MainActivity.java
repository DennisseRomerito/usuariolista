...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVerUsuarios.setOnClickListener(v ->{
            startActivity(new Intent(MainActivity.this, activity_lista_usuarios.class)); //la miss en vez de poner activity_main puso MainActivity y en la lista puso ListaUsuarios
        });
    }
